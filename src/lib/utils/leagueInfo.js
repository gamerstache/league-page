/*   STEP 1   */
export const leagueID = "1049406414680174592"; // your league ID
export const leagueName = "DANK ASS"; // your league name
...
export const homepageText = `
  <p>DANK ASS FANTASY FOOOTBALL LEAGUE</p>
`;
